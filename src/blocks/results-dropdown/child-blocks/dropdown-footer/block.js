...
import DropdownFooterAttributes from './attributes';
...
const moreTextTypographyAttributes = TypographyAttributes( 'moreTextTypo' );
const moreLinkTypographyAttributes = TypographyAttributes( 'moreLinkTypo' );
 ...
 */
registerBlockType( 'wp-predictive-search/dropdown-footer', {
	// Block name. Block names must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
	title: __( 'Results Dropdown Footer' ), // Block title.
	apiVersion: 2,
	icon: {
		src: IconChild,
		foreground: '#24b6f1',
	...
	attributes: {
		...DropdownFooterAttributes,
		...moreTextTypographyAttributes,
		...moreLinkTypographyAttributes,
		...spacingAttributes,
	},
