...
class Header_Template extends FrameWork\Admin_UI
{
	 ...
	 */
	public $option_name = 'wp_predictive_search_header_template_settings';
	
	/**
	 * @var string
	 * You must change to correct form key that you are working
	 */
	public $form_key = 'wp_predictive_search_header_template_settings';
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			...
			'label'				=> __( 'Header Template', 'wp-predictive-search' ),
			'callback_function'	=> 'wp_predictive_search_header_template_settings_form',
		);
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->form_key . '_settings_fields', array(
			...
			array(
				...
				'id' 		=> 'header_popup_item_name_font',
				'type' 		=> 'typography',
			...
			array(
				...
				'id' 		=> 'header_popup_item_name_hover_color',
				'type' 		=> 'color',
				'default'	=> '#ffffff',
			),
			array(
				'name' 		=> __( 'Item Description Font', 'wp-predictive-search' ),
				'id' 		=> 'header_popup_item_desc_font',
				'type' 		=> 'typography',
			...
			array(
				...
				'id' 		=> 'header_popup_item_category_hover_color',
...
/** 
 * wp_predictive_search_header_template_settings_form()
 * Define the callback function to show subtab content
 */
function wp_predictive_search_header_template_settings_form() {
	global $wp_predictive_search_header_template_settings_panel;
	$wp_predictive_search_header_template_settings_panel->settings_form();
}
