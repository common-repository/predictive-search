...
class Less_Sass
{
    ...
    public $css_file_name = 'wp_predictive_search';
    public $plugin_folder = WPPS_FOLDER;
    public $plugin_dir    = WPPS_DIR;
    ...
    public function sass_content_data()
    {
        ...
        include( $this->plugin_dir. '/templates/dynamic-styles/results-style.php' );
		$sass = ob_get_clean();
