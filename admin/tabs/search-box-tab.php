...
{	
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'wp_predictive_search_input_box_settings_tab_manager',
		);
	...
	public function settings_include() {
		...
		$wp_predictive_search_input_box_settings_panel = new FrameWork\Settings\Search_Box();
 ...
 */
function wp_predictive_search_input_box_settings_tab_manager() {
	global $wp_predictive_search_input_box_settings_tab;
	$wp_predictive_search_input_box_settings_tab->tab_manager();
}
