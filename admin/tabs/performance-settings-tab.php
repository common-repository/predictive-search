...
{	
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'wp_predictive_search_performance_settings_tab_manager',
		);
	...
	public function settings_include() {
		...
		$wp_predictive_search_performance_settings = new FrameWork\Settings\Performance();
 ...
 */
function wp_predictive_search_performance_settings_tab_manager() {
	global $wp_predictive_search_performance_settings_tab;
	$wp_predictive_search_performance_settings_tab->tab_manager();
}
