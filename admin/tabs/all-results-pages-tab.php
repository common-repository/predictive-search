...
{	
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'wpps_all_results_page_tab_manager',
		);
	...
	public function settings_include() {
		...
		$wpps_all_results_page_settings = new FrameWork\Settings\All_Results_Pages();
 ...
 */
function wpps_all_results_page_tab_manager() {
	global $wpps_all_results_page_tab;
	$wpps_all_results_page_tab->tab_manager();
}
